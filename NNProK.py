...
TEST, TEST_out, PATH, TEST2, TEST_out2, PATH2 = create_test_tab_one_filter_rand_batch_valid(NB_IMAGE//2)
TESTV, TESTV_out, PATHV, TESTV2, TESTV_out2, PATHV2 = create_test_tab_one_filter_rand_batch_valid(NB_IMAGE//2)

nn = NeuralNetwork([256, 128, 64, 32, 16, 8, 2], 0.1)
...
print("PCT : " +  str(good / NB_IMAGE * 100.0) + "%")
